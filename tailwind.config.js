...
export default {
  ...
  theme: {
  	extend: {
  		...
  		colors: {
        'dark-primary': 'rgb(10 10 20)',
        'dark-secondary': 'rgb(20 20 30)',
        'neon-green': 'rgb(50 205 50)',
        'gold-accent': 'rgb(255 215 0)',
  		...
  		boxShadow: {
  			...
  			glow: '0 0 20px -5px rgba(50, 205, 50, 0.4)',
  			'glow-lg': '0 0 40px -10px rgba(50, 205, 50, 0.3)',
  		...
  		keyframes: {
  			...
  			'glow-subtle': {
  				'0%, 100%': { boxShadow: '0 0 15px -3px rgba(50, 205, 50, 0.3)' },
  				'50%': { boxShadow: '0 0 25px -3px rgba(50, 205, 50, 0.5)' }
  			},
  			float: {
        ...
        scroll: 'scroll 40s linear infinite',
  		...
  		backgroundImage: {
        'futuristic-gradient': 'radial-gradient(circle at top left, rgba(50, 205, 50, 0.2), transparent 40%), radial-gradient(circle at bottom right, rgba(255, 215, 0, 0.15), transparent 50%)',
        'section-separator-gradient': 'linear-gradient(to bottom, rgb(10 10 20), rgb(20 20 30))',
